function Information(props) {
    ...
    {
        return (
              <div className=" flex  justify-center mt-[20px] h-[300px] bg-[#fff] w-[900px] rounded-2xl shadow-phuongCustom">
                <div className=" flex mt-[20px]">
                    ...
                    <div className=" text-lg">
                        ...
                        {/* name1 */}
                    <div className="ml-[2px] text-lg font-bold">
                ...
                <div className=" flex mt-[20px] ml-[20px]">
                    ...
                    <div className="ml-[5px] text-lg font-bold">
                    ...
                    <div className="ml-[10px] text-lg">
                        ...
                        <p className="flex mt-[15px]">Bìa cứng</p>
