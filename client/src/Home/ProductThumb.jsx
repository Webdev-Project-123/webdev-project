...
export const addToCart = (product, setCart, value = 1) => {
  ...
  if (!currCart.some(e => e.title === product.title)) {
    currCart.push({
      ...product,
      count: 1
    })
...
const ProductThumb = ({ productData }) => {
  ...
  return (
    <div className="m-2 sm:m-7 md:m-3 lg:m-5 bg-gray-50 rounded-lg transition duration-300 hover:cursor-pointer 
